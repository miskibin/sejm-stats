...
class ClubDetailSerializer(serializers.ModelSerializer):
    ...
    def get_age_distribution(self, obj):
        ...
        age_distribution = (
            obj.envoys.annotate(
                age=ExpressionWrapper(
                    current_year - ExtractYear("birthDate"), output_field=IntegerField()
                )
            )
            .values("age")
        ...
        age_ranges = {"<30": 0, "30-39": 0, "40-49": 0, "50-59": 0, "60+": 0}
    ...
    def get_interpellations_per_month(self, obj):
        ...
        return (
            Interpellation.objects.filter(
                fromMember__club=obj, receiptDate__gte=six_months_ago
            )
